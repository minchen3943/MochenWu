...
export default function Footer() {
  return (
    <div className="flex w-full flex-col bg-[#e6cfea72] border-t border-purple-300/50">
      <div className="flex w-full h-fit lg:px-44 pt-5 text-2xl font-sans justify-center lg:justify-normal text-[#e9b5e4dc]">
        <div className="w-fit h-fit">
          ...
          <ul className="pl-3 inline-flex gap-3">
            ...
            <li className="size-8">
              <a href="https://x.com/minchen3943" title="Twitter">
                <p className="flex items-center justify-center size-8 bg-black rounded-full transition duration-200 ease-in-out hover:scale-110">
                  <svg
                    className="size-4"
                    viewBox="0 0 1024 1024"
            ...
            <li className="size-8">
              <a href="mailto:minchen3943@outlook.com" title="Email">
                <p className="flex items-center justify-center size-8 bg-orange-700 rounded-full text-white transition duration-200 ease-in-out hover:scale-110">
                  <FontAwesomeIcon
                    icon={faEnvelope}
      ...
      <div className="flex w-full h-fit my-3 lg:mt-2 lg:px-44 text-sm justify-center lg:justify-normal text-[#626262] font-sans">
        <span className="flex">
          ...
          <a
            ...
            title="瞑尘"
            className="underline underline-offset-4 decoration-1 decoration-[#bcbcbc] hover:decoration-black hover:text-black transition duration-300 ease-in-out">
            瞑尘
          </a>
          <span className="px-1 opacity-50 items-center">|</span>
          Powered by&ensp;
          <a
